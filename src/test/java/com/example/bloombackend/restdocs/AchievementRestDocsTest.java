...
public class AchievementRestDocsTest {
	...
	private SeedEntity flowerEntity;
	...
	void setUp() throws Exception {
		...
		// 테스트 용 꽃 엔티티 등록
		flowerEntity = seedRepository.save(
			SeedEntity.builder()
				.name("장미 씨앗")
	...
	private void createAchievement(DailyAchievementEntity achievement, LocalDateTime dateTime,
		int achievementLevel) throws Exception {
