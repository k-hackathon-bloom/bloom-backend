...
include::{snippets}/api-bottle-message-test/get-recent-send-time/request-body.adoc[]
...
include::{snippets}/api-bottle-message-test/get-recent-send-time/request-fields.adoc[]
